...
public class BBSComment {
	...
	public BBSComment(int id, int bbsDocumentId, int memberId, String writerName, String writerPw, String email,
			String content, String ipAddress, String regDate, String editDate) {
		super();
		this.id = id;
	...
	public String toString() {
		return "BBSComment [id=" + id + ", bbsDocumentId=" + bbsDocumentId + ", memberId=" + memberId + ", writerName="
				+ writerName + ", writerPw=" + writerPw + ", email=" + email + ", content=" + content + ", ipAddress="
				+ ipAddress + ", regDate=" + regDate + ", editDate=" + editDate + "]";
	}
