...
public class BBSDocument {
	...
	public BBSDocument(int id, int memberId, String writerName, String writerPw, String email, String subject,
			String content, String ipAddress, int hit, String regDate, String editDate) {
		super();
		this.id = id;
	...
	public String toString() {
		return "BBSDocument [id=" + id + ", memberId=" + memberId + ", writerName=" + writerName + ", writerPw="
				+ writerPw + ", email=" + email + ", subject=" + subject + ", content=" + content + ", ipAddress="
				+ ipAddress + ", hit=" + hit + ", regDate=" + regDate + ", editDate=" + editDate + "]";
	}
