...
public class Member {
	...
	public Member(int id, String userId, String userPw, String userName, String email, String tel, String postcode,
			String addr1, String addr2, String regDate, String editDate) {
		super();
		this.id = id;
		this.userId = userId;
		this.userPw = userPw;
	...
	public String toString() {
		return "Member [id=" + id + ", userId=" + userId + ", userPw=" + userPw + ", userName=" + userName + ", email="
