...
public class BBSFile {
	...
	public BBSFile(int id, int bbsDocumentId, String fileDir, String fileName, long fileSize, String fileType,
			String orginName, String regDate, String editDate) {
		super();
		this.id = id;
	...
	public String toString() {
		return "BBSFile [id=" + id + ", bbsDocumentId=" + bbsDocumentId + ", fileDir=" + fileDir + ", fileName="
				+ fileName + ", fileSize=" + fileSize + ", fileType=" + fileType + ", orginName=" + orginName
